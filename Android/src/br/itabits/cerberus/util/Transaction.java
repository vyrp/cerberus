...
public class Transaction {
     ...
     * 
     * @param start The date of the borrowing
     * @param name The name of the borrower
     * @param end The returning date
     */
     ...
     * In the serialized string the transactions should be separated by <b>|</b> and
     * the fields in each transaction should be separated by <b>;</b>.
